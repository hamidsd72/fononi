...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{route('admin.index')}}" class="logo logo-dark">
            <span class="logo-sm">
                <img src="{{  fav_icon() }}" alt="" height="22">
            </span>
            <span class="logo-lg">
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                <li class="menu-title text-center"><span class="fs-15">امروز: {{my_jdate(date('Y-m-d'),'Y/m/d')}}</span>
                <li class="nav-item">
                    <a href="{{url('/')}}" target="_blank" class="nav-link"><i class="fas fa-home"></i> <span>صفحه اصلی سایت</span> </a>
                </li>
                @canany(['permission_cat_list','permission_list','role_list'])
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#AccessDashboards" data-bs-toggle="collapse" role="button"
                           aria-expanded="false" aria-controls="AccessDashboards">
                            <i class="fas fa-code"></i> <span>دسترسی ها</span>
                        </a>
                        <div class="collapse menu-dropdown" id="AccessDashboards">
                            <ul class="nav nav-sm flex-column">
                                @can('permission_cat_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.permissionCat.index')}}" class="nav-link">مدل</a>
                                    </li>
                                @endcan
                                @can('permission_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.permission.index')}}" class="nav-link">مجوز</a>
                                    </li>
                                @endcan
                                @can('role_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.role.index')}}" class="nav-link">رول</a>
                                    </li>
                                @endcan
                            </ul>
                        </div>
                ...
                @canany(['user_list','user_job_fixer_list'])
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#UserDashboards" data-bs-toggle="collapse" role="button"
                           aria-expanded="false" aria-controls="UserDashboards">
                            <i class="fas fa-user"></i> <span>کاربران</span>
                        </a>
                        <div class="collapse menu-dropdown" id="UserDashboards">
                            <ul class="nav nav-sm flex-column">
                                @can('user_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.user.index')}}" class="nav-link">کاربران</a>
                                    </li>
                                @endcan
                                @can('user_job_fixer_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.user.job.fixer.list')}}" class="nav-link">کاربران(ارزیابی)</a>
                                    </li>
                                @endcan
                                @can('user_job_fixer_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.agent.index')}}" class="nav-link">کاربران(نمایدگی)</a>
                                    </li>
                                @endcan
                            </ul>
                        </div>
                ...
                @endcan
                @canany(['agent_level_list','agent_package_list'])
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#AgentDashboards" data-bs-toggle="collapse" role="button"
                           aria-expanded="false" aria-controls="AgentDashboards">
                            <i class="fas fa-users"></i> <span>نمایندگی</span>
                        </a>
                        <div class="collapse menu-dropdown" id="AgentDashboards">
                            <ul class="nav nav-sm flex-column">
                                @can('agent_level_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.agent-level.index')}}" class="nav-link">لول نمایندگی</a>
                                    </li>
                                @endcan
                                    @can('agent_package_list')
                                        <li class="nav-item">
                                            <a href="{{route('admin.agent-package.index')}}" class="nav-link">پکیج</a>
                                        </li>
                                    @endcan
                            </ul>
                        </div>
                ...
                @endcan
                @canany(['entrepreneurship_page_list','entrepreneurship_project_list'])
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#EntrepreneurshipDashboards" data-bs-toggle="collapse" role="button"
                           aria-expanded="false" aria-controls="EntrepreneurshipDashboards">
                            <i class="fas fa-briefcase"></i> <span>کارآفرینی</span>
                        </a>
                        <div class="collapse menu-dropdown" id="EntrepreneurshipDashboards">
                            <ul class="nav nav-sm flex-column">
                                @can('entrepreneurship_page_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.entrepreneurship-page.index')}}" class="nav-link">اطلاعات صفحه</a>
                                    </li>
                                @endcan
                                @can('entrepreneurship_project_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.entrepreneurship-project.index')}}" class="nav-link">پروژه ها</a>
                                    </li>
                                @endcan
                            </ul>
                        </div>
                ...
                @endcan
                @canany(['job_list','job_work_list','job_level_assessment_list','job_level_package_list','job_email_package_list','job_send_email_list','job_level_page_list'])
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#JobDashboards" data-bs-toggle="collapse" role="button"
                           aria-expanded="false" aria-controls="JobDashboards">
                            <i class="fas fa-person-digging"></i> <span>جاب فیکسر</span>
                        </a>
                        <div class="collapse menu-dropdown" id="JobDashboards">
                            <ul class="nav nav-sm flex-column">

{{--                                @can('job_list')--}}
{{--                                    <li class="nav-item">--}}
{{--                                        <a href="{{route('admin.job.index')}}" class="nav-link">شغل ها</a>--}}
{{--                                    </li>--}}
{{--                                @endcan--}}
                                @canany(['job_email_package_list','job_send_email_list'])
                                <li class="nav-item">
                                    <a href="#sidebarJobEmail" class="nav-link" data-bs-toggle="collapse" role="button"
                                       aria-expanded="false" aria-controls="sidebarJobEmail">ایمیلی
                                    </a>
                                    <div class="collapse menu-dropdown" id="sidebarJobEmail">
                                        <ul class="nav nav-sm flex-column">


                                            @can('job_send_email_list')
                                                <li class="nav-item">
                                                    <a href="{{route('admin.job-send-email.create')}}" class="nav-link">ارسال ایمیل</a>
                                                </li>
                                            @endcan

                                            @can('job_email_package_list')
                                            <li class="nav-item">
                                                <a href="{{route('admin.job-email-package.index')}}" class="nav-link">پکیج</a>
                                            </li>
                                            @endcan
                                        </ul>
                                    </div>
                                ...
                                @can('job_work_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.job-work.index')}}" class="nav-link">شغل های کاریابی</a>
                                    </li>
                                @endcan
                                @can('job_level_assessment_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.job-level-assessment.index')}}" class="nav-link">مراحل ارزیابی</a>
                                    </li>
                                @endcan
                                @can('job_level_page_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.job-level-page.index')}}" class="nav-link">صفحه مراحل ارزیابی</a>
                                    </li>
                                @endcan
                                @can('job_level_package_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.job-level-package.index')}}" class="nav-link">پکیج ارزیابی</a>
                                    </li>
                                @endcan
                            </ul>
                        </div>
                ...
                @endcan
                @canany(['property_locale_list','property_property_list','property_project_list'])
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#PropertyDashboards" data-bs-toggle="collapse" role="button"
                           aria-expanded="false" aria-controls="PropertyDashboards">
                            <i class="fas fa-home"></i> <span>املاک</span>
                        </a>
                        <div class="collapse menu-dropdown" id="PropertyDashboards">
                            <ul class="nav nav-sm flex-column">
                                @can('property_locale_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.property-locale.index')}}" class="nav-link">مناطق</a>
                                    </li>
                                @endcan
                                @can('property_property_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.property.index')}}" class="nav-link">ویژگی ها</a>
                                    </li>
                                @endcan
                                @can('property_project_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.property-project.index')}}" class="nav-link">پروژه ها</a>
                                    </li>
                                @endcan
                            </ul>
                        </div>
                ...
                @endcan
                @canany(['counseling_cat_list','counseling_package_list'])
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#CounselingDashboards" data-bs-toggle="collapse" role="button"
                           aria-expanded="false" aria-controls="CounselingDashboards">
                            <i class="fas fa-chalkboard-user"></i> <span>مشاوره</span>
                        </a>
                        <div class="collapse menu-dropdown" id="CounselingDashboards">
                            <ul class="nav nav-sm flex-column">
                                @can('counseling_cat_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.counseling-cat.index')}}" class="nav-link">دسته</a>
                                    </li>
                                @endcan
                                @can('counseling_package_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.counseling-package.index')}}" class="nav-link">پکیج</a>
                                    </li>
                                @endcan
                            </ul>
                        </div>
                ...
                @endcan
                @canany(['off_code_list','country_list','country_code_list','setting_site_edit','menu_list','education_list','job_status_list','marital_list','list_lang_list','introduction_list'])
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#CogDashboards" data-bs-toggle="collapse" role="button"
                           aria-expanded="false" aria-controls="CogDashboards">
                            <i class="fas fa-cog"></i> <span>تنظیمات</span>
                        </a>
                        <div class="collapse menu-dropdown" id="CogDashboards">
                            <ul class="nav nav-sm flex-column">
                                @can('setting_site_edit')
                                    <li class="nav-item">
                                        <a href="{{route('admin.setting.site.edit')}}" class="nav-link">تنظیمات سایت</a>
                                    </li>
                                @endcan
                                @can('menu_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.menu.index')}}" class="nav-link">منو ها</a>
                                    </li>
                                @endcan
                                @can('off_code_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.off-code.index')}}" class="nav-link">کد تخفیف</a>
                                    </li>
                                @endcan
                                @can('country_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.country.index')}}" class="nav-link">کشورها</a>
                                    </li>
                                @endcan
                                @can('country_code_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.country-code.index')}}" class="nav-link">کد کشورها</a>
                                    </li>
                                @endcan
                                @can('education_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.education.index')}}" class="nav-link">لیست کشویی میزان تحصیلات</a>
                                    </li>
                                @endcan
                                @can('job_status_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.job-status.index')}}" class="nav-link">لیست کشویی وضعیت شغلی</a>
                                    </li>
                                @endcan
                                @can('marital_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.marital.index')}}" class="nav-link">لیست کشویی وضعیت تاهل</a>
                                    </li>
                                @endcan
                                @can('list_lang_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.list-lang.index')}}" class="nav-link">لیست کشویی زبان</a>
                                    </li>
                                @endcan
                                @can('introduction_list')
                                    <li class="nav-item">
                                        <a href="{{route('admin.introduction.index')}}" class="nav-link">لیست کشویی آشنایی با شرکت</a>
                                    </li>
                                @endcan
                            </ul>
                        </div>
                ...
                @endcan
                @canany(['report_activity_list',
                        'report_sale_email_package_list','report_sale_level_package_list','counseling_request_list',
                        'report_request_entrepreneurship_list','entrepreneurship_project_request_list','report_request_job_work_list'])
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#ReportDashboards" data-bs-toggle="collapse" role="button"
                       aria-expanded="false" aria-controls="ReportDashboards">
                        <i class="fas fa-chart-bar"></i>
                        <span>گزارشات</span>
                    </a>
                    <div class="collapse menu-dropdown" id="ReportDashboards">
                        <ul class="nav nav-sm flex-column">
                            @canany(['report_sale_email_package_list','report_sale_level_package_list','counseling_request_list'])
                                <li class="nav-item">
                                    <a href="#sidebarSale" class="nav-link" data-bs-toggle="collapse" role="button"
                                       aria-expanded="false" aria-controls="sidebarSale">فروش
                                    </a>
                                    <div class="collapse menu-dropdown" id="sidebarSale">
                                        <ul class="nav nav-sm flex-column">


                                            @can('report_sale_email_package_list')
                                                <li class="nav-item">
                                                    <a href="{{route('admin.report.sale.job.mail.index')}}" class="nav-link">
                                                        پکیج ایمیل
                                                        @if($sale_email_package_count > 0)
                                                        <span class="badge bg-danger">{{ $sale_email_package_count }}</span>
                                                        @endif
                                                    </a>
                                                </li>
                                            @endcan
                                            @can('report_sale_level_package_list')
                                                <li class="nav-item">
                                                    <a href="{{route('admin.report.sale.job.level.index')}}" class="nav-link">
                                                        پکیج ارزیابی
                                                        @if($sale_level_package_count > 0)
                                                        <span class="badge bg-danger">{{ $sale_level_package_count }}</span>
                                                        @endif
                                                    </a>
                                                </li>
                                            @endcan
                                                @can('counseling_request_list')
                                                    <li class="nav-item">
                                                        <a href="{{route('admin.report.sale.counseling.package.index')}}" class="nav-link">
                                                            پکیج مشاوره
                                                            @if($counseling_request_count > 0)
                                                                <span class="badge bg-danger">{{ $counseling_request_count }}</span>
                                                            @endif
                                                        </a>
                                                    </li>
                                                @endcan
                            ...
                            @endcan
                            @canany(['report_request_entrepreneurship_list','entrepreneurship_project_request_list','report_request_job_work_list'])
                                <li class="nav-item">
                                    <a href="#sidebarRequest" class="nav-link" data-bs-toggle="collapse" role="button"
                                       aria-expanded="false" aria-controls="sidebarRequest">درخواست
                                    </a>
                                    <div class="collapse menu-dropdown" id="sidebarRequest">
                                        <ul class="nav nav-sm flex-column">
                                            @can('entrepreneurship_request_list')
                                                <li class="nav-item">
                                                    <a href="{{route('admin.report.request.entrepreneurship')}}" class="nav-link">کارآفرینی
                                                        @if($entrepreneurship_request_count > 0)
                                                            <span class="badge bg-danger">{{ $entrepreneurship_request_count }}</span>
                                                        @endif
                                                    </a>
                                                </li>
                                            @endcan
                                            @can('entrepreneurship_project_request_list')
                                                <li class="nav-item">
                                                    <a href="{{route('admin.report.request.entrepreneurship.project')}}" class="nav-link">پروژه کارآفرینی
                                                        @if($entrepreneurship_request_project_count > 0)
                                                            <span class="badge bg-danger">{{ $entrepreneurship_request_project_count }}</span>
                                                        @endif
                                                    </a>
                                                </li>
                                            @endcan
                                            @can('report_request_job_work_list')
                                                <li class="nav-item">
                                                    <a href="{{route('admin.report.request.job.work')}}" class="nav-link">
                                                        شغل کاریابی
                                                        @if($job_work_request_count > 0)
                                                        <span class="badge bg-danger">{{ $job_work_request_count }}</span>
                                                        @endif
                                                    </a>
                                                </li>
                                            @endcan
                            ...
                            @endcan
                            @can('report_activity_list')
                                <li class="nav-item">
                                    <a href="{{route('admin.activity.index')}}" class="nav-link">گزارش سایت</a>
                                </li>
                            @endcan
                        </ul>
                    </div>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="auth-pass-reset-basic"
                                               class="nav-link">@lang('translation.basic')</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-pass-reset-cover"
                                               class="nav-link">@lang('translation.cover')</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        <li class="nav-item">
                                            <a href="pages-profile"
                                               class="nav-link">@lang('translation.simple-page')</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="pages-profile-settings"
                                               class="nav-link">@lang('translation.settings')</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="ui-accordions"
                                           class="nav-link">@lang('translation.accordion-collapse')</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="ui-notifications"
                                           class="nav-link">@lang('translation.notifications')</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-lg-4">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarForms" data-bs-toggle="collapse" role="button"
                       aria-expanded="false" aria-controls="sidebarForms">
                        <i class="lar la-newspaper"></i> <span>@lang('translation.forms')</span>
                    </a>
                        ...
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="forms-checkboxs-radios"
                                   class="nav-link">@lang('translation.checkboxs-radios')</a>
                            </li>
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarTables" data-bs-toggle="collapse" role="button"
                       aria-expanded="false" aria-controls="sidebarTables">
                        <i class="las la-table"></i> <span>@lang('translation.tables')</span>
                    </a>
                                    ...
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-column"
                                               class="nav-link">@lang('translation.column')</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-timeline"
                                               class="nav-link">@lang('translation.timeline')</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-candlestick"
                                               class="nav-link">@lang('translation.candlstick')</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-boxplot"
                                               class="nav-link">@lang('translation.boxplot')</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-bubble"
                                               class="nav-link">@lang('translation.bubble')</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-scatter"
                                               class="nav-link">@lang('translation.scatter')</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-heatmap"
                                               class="nav-link">@lang('translation.heatmap')</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="charts-apex-treemap"
                                               class="nav-link">@lang('translation.treemap')</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-radialbar"
                                               class="nav-link">@lang('translation.radialbar')</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="charts-apex-polar"
                                               class="nav-link">@lang('translation.polar-area')</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
